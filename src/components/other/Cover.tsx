...
export default component$(({ show, tryCount, countryName }: Props) => {
  //@ts-ignore
  ...
  return (
    <div
      ref={dialogRef}
      class={`dialog absolute z-10 shadow-md left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 rounded-xl p-2 sm:p-4 flex flex-col justify-center ${show ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"}`}
    >
      ...
      <button class="relative flex items-center gap-1 border-slate-300 border-2 border-solid p-3 group w-fit mx-auto mt-8">
